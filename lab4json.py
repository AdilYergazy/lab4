...
for i in range(len(a.keys())):
    print((a['imdata'][i]['l1PhysIf']['attributes']['dn']), end=' ')
    print(a['imdata'][i]['l1PhysIf']['attributes']['descr'], end='                             ')
    print(a['imdata'][i]['l1PhysIf']['attributes']['speed'], end='  ')
    print(a['imdata'][i]['l1PhysIf']['attributes']['mtu'], end=' ')
